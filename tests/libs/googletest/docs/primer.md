...
1.  Tests should be well *organized* and reflect the structure of the tested
    ...
    projects and start to work on a new code _base.
...
provided by linking in `"//testing/_base/public:gtest_main"`. If that doesn't
cover what you need, you should write your own main() function, which should
return the value of `RUN_ALL_TESTS()`. Link to `"//testing/_base/public:gunit"`.
